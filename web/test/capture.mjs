...
import { shouldStop, frameGate, quickSigma, limitEstimate, resample, SESSION_DEFAULTS } from '../src/capture.js';
...
export function runCaptureTests(check, near) {
  ...
  {
    const W = 420, H = 315;
    const blobs = makeBlobs({ width: W, height: H, count: 900, seed: 21 });
    const wide = renderBlobs(blobs, W, H, { noise: 0.01, seed: 1 });
